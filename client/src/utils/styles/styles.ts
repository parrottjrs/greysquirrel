export const STYLES = {
  ...
  SIGNUP_ANCHOR:
    "py-2 px-6 bg-aeroBlue font-IBM font-medium text-sm text-base text-nero no-underline",
  SQUIRREL_IMAGE: "w-72 h-72",
  WELCOME_HEADER: "text-nero text-xl font-IBM font-medium md:text-3xl",

  //NAVBAR
  NAVBAR_HEADER:
    "text-center text-nero text-md font-IBM font-medium md:text-2xl",
  NAVBAR_TEXT: "mt-1 text-center text-nero text-sm font-IBM font-medium",
  BASIC_LINK: "text-nero font-IBM font-medium no-underline",
  LINK_CONTAINER: "flex flex-row items-center space-x-8",

  // SIGNIN
  SIGNIN_PARENT_CONTAINER:
    "md:h-screen md:mt-18 flex flex-col items-center justify-center",
  SIGNIN_HEADER:
    "mb-0 text-left text-nero text-xl font-IBM font-medium md:text-3xl",
  LABEL: "text-center text-nero text-sm font-IBM font-medium md:text-base",
  VIOLET_TEXT:
  ...
  ALERT_DIV: "-mt-2 -mb-10 w-60 md: w-[404px] flex items-center",
  ALERT_TEXT:
  ...
  DOC_HEADER: "m-0 text-nero text-sm font-IBM font-medium md:text-2xl",
  CREATE_BUTTON:
